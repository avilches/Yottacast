...
public enum ActionModifiers { None = 0, Meta = 1, Shift = 2, MetaShift = 3, MetaAlt = 4 }
...
public sealed record ActionHotkey(string Key, ActionModifiers Modifiers = ActionModifiers.None) {
    ...
    public static readonly ActionHotkey MetaAltLeft  = new("Left",  ActionModifiers.MetaAlt);
    public static readonly ActionHotkey MetaAltRight = new("Right", ActionModifiers.MetaAlt);
}
