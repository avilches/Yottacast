...
| `fonts` | 7 tamanos de fuente + 4 familias tipograficas | `"search": 18` |
...
| `searchFontFamily` | `Theme.FontFamilySearch` |
| `calcFontFamily` | `Theme.FontFamilyCalc` |
| `emojiFontFamily` | `Theme.FontFamilyEmoji` |
