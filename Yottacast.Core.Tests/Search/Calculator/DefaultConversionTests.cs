...
public class DefaultConversionTests(MathJsEngineFixture fixture, NerdamerEngineFixture nerdamerFixture) : IClassFixture<NerdamerEngineFixture> {
    ...
    public static TheoryData<string, string> DefaultConversionCases => new() {
        ...
        { "100000000 s",    "100000000 s    | 100000000 seconds                                -> 3 year 61 day 15 h 47 min | 3 years 61 days 15 hours 47 minutes" },
    ...
    public static TheoryData<string, string> Second_SIPrefixCases => new() {
        ...
        { "1 Gs", "1 Gs | 1 gigasecond  -> 31 year 251 day 7 h 47 min   | 31 years 251 days 7 hours 47 minutes" },
        { "1 Ts", "1 Ts | 1 terasecond  -> 31688 year 32 day 1 h 47 min | 31688 years 32 days 1 hour 47 minutes" },
